...
def predict_endpoint():
    ...
    if received_wind_speed_avg:
        received_data_df['Ws1_avg'] = received_wind_speed_avg

    features_df = prepare_features(received_data_df, training_mode=False)
    return jsonify(predict(features_df, MODEL_PATH)["predictions"].to_json())
